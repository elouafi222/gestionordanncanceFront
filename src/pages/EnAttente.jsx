              ...
              {isLoading ? (
                ...
                ordonnances.map((ordonnance, index) => (
                  ...
                  >
                    <th
                      scope="row"
                      className="px-3 py-4 font-medium text-gray-600 whitespace-nowrap rounded-l-lg"
                    >
                      ORD-{ordonnance.numero + " "}{" "}
                      {ordonnance.type !== "unique" ? (
                        <span className="px-2 py-1 ms-2 text-sm rounded-lg bg-sky-400 text-white">
                          R
                        </span>
                      ) : (
